...
function Dropdown(props) {
    ...
    return (
        <div className='relative'>
            <button type="button" className={"bg-white hover:bg-gray-200 text-black active:text-white flex items-center justify-between px-2 py-2 transition duration-200 rounded-lg active:bg-blue-500 group w-40"} aria-controls="sidebar-dropdown" data-collapse-toggle="sidebar-dropdown">
            ...
            <ul id="sidebar-dropdown" className="p-2 space-y-2 absolute w-full bg-gray-200 rounded-lg">
                <li>
...
function Profile(props) {
    return (
        <div className='p-2 rounded-lg text-right transition-transform -translate-x-full sm:translate-x-0 hidden md:block'>
