...
export default function PopUp(props) {
    return (
        <div className="fixed top-0 left-0 h-screen w-screen bg-black bg-opacity-70 z-50">
            <div className="bg-zinc-800 max-w-screen sm:w-96 min-w-fit absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg shadow shadow-black p-2">
